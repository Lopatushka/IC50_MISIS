...
#
path_to_file = ["C:/Users/User/Documents/Work/Data/MTS/12.04.21_MTS/12.04.21_MTS_MCF7.xlsx"]
#
...
# Normalization
df.normalization(control_dict={'DG4ClSe': 'DMSO-dil3',
                               'DG603k': 'DMSO-dil3',
                               'DG605k': 'DMSO-dil2', 'DG618k': 'DMSO-dil2'})
...
exp.Export(data=df.reshape(), name='MCF7.xlsx', path_to_dir=path_to_export)